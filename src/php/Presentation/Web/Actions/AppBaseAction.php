...
class AppBaseAction extends Action {
    ...
    public function setUser() {
        ...
        $this->page['user'] = empty($uinfo) ? array('id'=>0,'account'=>'','screenname'=>'', 'image_id'=>0) : json_decode($uinfo,true);
    }
    ...
    public function deal() {
        logDebug(json_encode($this->page));
    ...
    private function setHeadInfo() {
        ...
        //
        if (isset($this->page['data']['title'])) {
            $this->page['head']['title'] = $this->page['data']['title'];
        }
        if (isset($this->page['data']['tags'])) {
            $this->page['head']['tags'] = $this->page['data']['tags'];
        }
        if (isset($this->page['data']['desc'])) {
