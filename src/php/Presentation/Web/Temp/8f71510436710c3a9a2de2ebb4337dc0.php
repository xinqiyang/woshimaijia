...
</div></div><?php endforeach; endif; else: echo "" ;endif; ?><div class="clear"></div><h2>今天推荐大家一起买的· · · · · ·<span class="pl">(<a href="__URL__/gomore/">更多</a>)</span></h2><?php if(is_array($page["goods"])): $i = 0; $__LIST__ = $page["goods"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="gblock"><a class="goods_photo"
...
</script><?php endif; ?><div class="cat-col5" style="margin-top:10px;"><a href=""><!-- <img src="__ROOT__/Resource/images/gg/1.png" />  --></a></div><h2>大家刚刚说 · · · · · <span class="pl">(<a href="/labels/">更多</a>)</span></h2><div style="float:left;width:100%;margin-bottom:3em"><?php if(is_array($page["comments"])): $i = 0; $__LIST__ = $page["comments"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><ul class="rblockul"><li class="mbtl"><a href="<?php echo U('people/space',array('id'=>$vo['uid']));?>"><img class="artist_s"
