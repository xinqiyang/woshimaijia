...
function dofocus(gid)
{
	...
	alt="<?php if(isset($uinfo["enname"])) { echo ($uinfo["enname"]); }  ?>"  /></a></div><?php endif; ?></div></div><div id="content"><h1><?php if(isset($page["title"])) { echo ($page["title"]); }  ?></h1><div class="grid-16-8 clearfix"><div class="amain"><div class="leftspace"><form action="<?php echo U('login/checklogin');?>" method="post" id="userlogin" name="userlogin">  	我的E-mail:<br /><input type="text" value="" size="46" maxlength="60" name="email" require="true" datatype="email" msg="帐户必须输入" tabindex="1" /> 我的E-mail,推荐使用QQ邮箱
  	<br /><br />    我的密码:<br /><input type="password" value="" maxlength="20" size="26" name="password" require="true" datatype="limit" min="5" max="20" msg="要输入密码" tabindex="2"/> 我的密码
    <a href="<?php echo U('login/forgetpass');?>">忘记密码了</a><br /><br /><input type="checkbox" name="autologin" checked="checked" /><span class="pl">在这台电脑上记住我(一个月之内不用再登录)</span><br/><br/><input type="submit" value="点击登录" class="btn-submit" name="user_login" /><script>	$('#userlogin').checkForm();
	</script></form></div></div><div class="aside"><h2>还没有注册</h2><p>>><a  href="<?php echo U('signup/index');?>">赶紧注册去...</a></p><br /></div><div class="extra"></div></div></div><div id="footer"><div class="fr"><a class="opt" style="margin-left:40px;" href="#top">返回顶部</a></div><div class="gray-link"><a href="<?php echo U('about/show',array('w'=>'aboutus'));?>">关于我是买家</a>|<a href="<?php echo U('about/show',array('w'=>'joinus'));?>">加入团队</a>|<a href="<?php echo U('about/show',array('w'=>'contactus'));?>">联系我们</a>|<a href="<?php echo U('about/show',array('w'=>'agreement'));?>">使用协议</a>|<a href="<?php echo U('about/show',array('w'=>'help'));?>">看看帮助</a>|<a href="<?php echo U('group/showgroup',array('id'=>'1'));?>">提提意见</a>|<a href="#" onclick="javascript:window.external.AddFavorite('__APP__','我是买家首页','我是买家首页');" rel="sidebar">加入收藏</a>|<a id="report" style="color:#c0c0c0" href="#">举报不良信息</a>		|<a  href="http://blog.woshimaijia.com/" target="_blank">我是买家官方博客</a></div><div style="float:right" class="gray-link">Copyright © woshimaijia.com 2010 All rights reserved.<a target="_blank" href="http://www.miibeian.gov.cn" >浙ICP备09035551号</a></div></div></div></body></html>