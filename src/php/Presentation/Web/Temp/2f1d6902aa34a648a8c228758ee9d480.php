...
function dofocus(gid)
{
	...
	alt="<?php if(isset($uinfo["enname"])) { echo ($uinfo["enname"]); }  ?>"  /></a></div><?php endif; ?></div></div><div id="content"><h1><?php if(isset($page["title"])) { echo ($page["title"]); }  ?></h1><div class="grid-16-8 clearfix"><div class="amain"><div class="leftspace"><form action="<?php echo U('signup/deal');?>" method="post" id="userreg" name="userreg"><span class="m">我的Email地址:</span><br/><input type="text" value="" maxlength="60" size="34" name="email" id="email" require="true" datatype="email|ajax" url="<?php echo U('signup/checkemail');?>" msg="邮箱不能为空" /><span class="attn hint" id="e_hint">请输入Email地址</span><br/><div id="e_correct"><span class="pl">用此邮箱接收确认邮件才能完成注册。</span></div><br/><span class="m">我的密码:</span><br/><input type="password" value="" maxlength="20" size="16" name="password" id="password" require="true" value="" datatype="limit" min="5" max="12" msg="密码不能为空"/><span class="attn hint" id="p_hint">请输入密码</span><br/><span class="pl">最少5个字符，请记住自己的密码。</span><br/><br/><span class="m">我的常用名:</span><br/><input type="text" value="" maxlength="15"  size="16" name="enname" id="enname" require="true" datatype="userName|limit|ajax" url="<?php echo U('signup/checkname');?>" min="4" max="20" msg="用户名只能由数字字母组成,长度为4-20个字符" /><span class="attn hint" id="n_hint">输入常用名,<font color="red">字母数字组成</font></span><br/><span class="pl">方便大家联系</span><br/><label><input type="checkbox" name="agreement" id="agreement" require="true" datatype="require" msg="请勾选" checked="checked"/>
    我已经认真阅读并同意我是卖家的《<a target="_blank" href="<?php echo U('about/show',array('w'=>'agreement'));?>">使用协议</a>》。
    </label><br/><br/><input type="submit" value="完成注册" class="btn-submit" id="button"/></form><script>
	$('#userreg').checkForm();
	</script></div></div><div class="aside"><h2>我是买家注册说明</h2><div class="pl"><p>我是买家  买家体验分享社区!大家一起逛逛,晒晒,发现的好东西;分享我的体验;侃侃,找到最好的!</p><br/><p>><a  href="<?php echo U('login/index');?>">我注册了去登录</a></p></div></div><div class="extra"></div></div></div><div id="footer"><div class="fr"><a class="opt" style="margin-left:40px;" href="#top">返回顶部</a></div><div class="gray-link"><a href="<?php echo U('about/show',array('w'=>'aboutus'));?>">关于我是买家</a>|<a href="<?php echo U('about/show',array('w'=>'joinus'));?>">加入团队</a>|<a href="<?php echo U('about/show',array('w'=>'contactus'));?>">联系我们</a>|<a href="<?php echo U('about/show',array('w'=>'agreement'));?>">使用协议</a>|<a href="<?php echo U('about/show',array('w'=>'help'));?>">看看帮助</a>|<a href="<?php echo U('group/showgroup',array('id'=>'1'));?>">提提意见</a>|<a href="#" onclick="javascript:window.external.AddFavorite('__APP__','我是买家首页','我是买家首页');" rel="sidebar">加入收藏</a>|<a id="report" style="color:#c0c0c0" href="#">举报不良信息</a>		|<a  href="http://blog.woshimaijia.com/" target="_blank">我是买家官方博客</a></div><div style="float:right" class="gray-link">Copyright © woshimaijia.com 2010 All rights reserved.<a target="_blank" href="http://www.miibeian.gov.cn" >浙ICP备09035551号</a></div></div></div></body></html>